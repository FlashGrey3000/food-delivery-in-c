...
void active_options(GtkWidget *widget, gpointer data) {
    ...
    button1 = gtk_button_new_with_label("1. Change Passwo");
    button2 = gtk_button_new_with_label("2. Show Restauran");
    button3 = gtk_button_new_with_label("3. Sign Out");
...
void on_login_clicked(GtkWidget *widget, gpointer data) {
    ...
    if (found) {
        g_signal_connect(Next_button, "clicked", G_CALLBACK(active_options), window);
        ...
        const char *message = "User Name & Passwords do not match.\n Please try again.";
...
void active_log(GtkWidget *widget, gpointer data){
    ...
    //g_signal_connect(Next_button, "clicked", G_CALLBACK(destroy_Window), window);
