...
int main() {
    ...
    //     (Transaction){ .items = (int[]){1, 2, 3}, .count = 3 },
    //     (Transaction){ .items = (int[]){1, 2, 4}, .count = 3 },
    //     (Transaction){ .items = (int[]){1, 3}, .count = 2 },
    //     (Transaction){ .items = (int[]){2, 3, 4}, .count = 3 },
    //     (Transaction){ .items = (int[]){2, 3}, .count = 2 }
    // };
    ...
    Itemset* candidates = (Itemset*)malloc(4 * sizeof(Itemset));
    candidates[0] = (Itemset){ .items = malloc(sizeof(int)), .count = 1, .support = 0 };
    candidates[0].items[0] = 1;
    candidates[1] = (Itemset){ .items = malloc(sizeof(int)), .count = 1, .support = 0 };
    candidates[1].items[0] = 2;
    candidates[2] = (Itemset){ .items = malloc(sizeof(int)), .count = 1, .support = 0 };
    candidates[2].items[0] = 3;
    candidates[3] = (Itemset){ .items = malloc(sizeof(int)), .count = 1, .support = 0 };
    candidates[3].items[0] = 4;
